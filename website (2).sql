...
(4, 'Trinh Van Duy', 20, 'C#', '3 years', 1, 1);
...
--
ALTER TABLE `trainee`
  MODIFY `idtrainee` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `category`
  ADD CONSTRAINT `category_ibfk_1` FOREIGN KEY (`idstaff`) REFERENCES `staff` (`idstaff`);

--
-- Các ràng buộc cho bảng `class`
--
ALTER TABLE `class`
  ADD CONSTRAINT `class_ibfk_1` FOREIGN KEY (`idstaff`) REFERENCES `staff` (`idstaff`),
  ADD CONSTRAINT `class_ibfk_2` FOREIGN KEY (`idcategory`) REFERENCES `category` (`idcategory`),
  ADD CONSTRAINT `class_ibfk_3` FOREIGN KEY (`idcourse`) REFERENCES `course` (`idcourse`),
  ADD CONSTRAINT `class_ibfk_4` FOREIGN KEY (`idtopic`) REFERENCES `topic` (`idtopic`);

--
-- Các ràng buộc cho bảng `course`
--
ALTER TABLE `course`
  ADD CONSTRAINT `course_ibfk_1` FOREIGN KEY (`idstaff`) REFERENCES `staff` (`idstaff`),
...
--
ALTER TABLE `staff`
  ADD CONSTRAINT `staff_ibfk_1` FOREIGN KEY (`idadmin`) REFERENCES `admin` (`idadmin`);

--
-- Các ràng buộc cho bảng `topic`
--
ALTER TABLE `topic`
  ADD CONSTRAINT `topic_ibfk_1` FOREIGN KEY (`idstaff`) REFERENCES `staff` (`idstaff`),
  ADD CONSTRAINT `topic_ibfk_2` FOREIGN KEY (`idcourse`) REFERENCES `course` (`idcourse`);

--
-- Các ràng buộc cho bảng `trainee`
--
ALTER TABLE `trainee`
  ADD CONSTRAINT `trainee_ibfk_1` FOREIGN KEY (`idstaff`) REFERENCES `staff` (`idstaff`),
  ADD CONSTRAINT `trainee_ibfk_2` FOREIGN KEY (`idclass`) REFERENCES `class` (`idclass`);

--
-- Các ràng buộc cho bảng `trainer`
--
ALTER TABLE `trainer`
  ADD CONSTRAINT `trainer_ibfk_1` FOREIGN KEY (`idstaff`) REFERENCES `staff` (`idstaff`),
  ADD CONSTRAINT `trainer_ibfk_2` FOREIGN KEY (`idadmin`) REFERENCES `admin` (`idadmin`),
  ADD CONSTRAINT `trainer_ibfk_3` FOREIGN KEY (`idclass`) REFERENCES `class` (`idclass`);
COMMIT;
